...
import { type ActorSheetPaneId, RouteView, type MobileRoute } from "../router/routes.ts";
import type {
...
const GENERATED_ADAPTERS_SOURCE = new URL("../systems/character-sheet-adapters.generated.ts", import.meta.url);
