...
test("recents template preserves required regions", async () => {
  ...
  const shellHelperSource = readFileSync(new URL("../core/mobile-shell/controller-helpers-shell.ts", import.meta.url), "utf8");
  const shellActionSource = readFileSync(new URL("../core/mobile-shell/actions-shell.ts", import.meta.url), "utf8");
