...
test("settings templates expose Foundry logout action", () => {
  const shellTemplate = readFileSync(new URL("../templates/shell.hbs", import.meta.url), "utf8");
  const settingsTemplate = readFileSync(new URL("../templates/settings.hbs", import.meta.url), "utf8");
  const actionsSource = readFileSync(new URL("../core/mobile-shell/actions-shell.ts", import.meta.url), "utf8");
  const foundryGlobalsSource = readFileSync(new URL("../core/foundry-globals.ts", import.meta.url), "utf8");
  const css = readFileSync(new URL("../styles/pocket-foundry.css", import.meta.url), "utf8");
...
test("bottom navigation renders Search and Settings as compact icons", () => {
  const bottomNavTemplate = readFileSync(new URL("../templates/partials/bottom-nav.hbs", import.meta.url), "utf8");
  const navigationHelperSource = readFileSync(new URL("../core/mobile-shell/controller-helpers-navigation.ts", import.meta.url), "utf8");
  const css = readFileSync(new URL("../styles/pocket-foundry.css", import.meta.url), "utf8");
