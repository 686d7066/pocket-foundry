...
import { bindNumberWheelDragging } from "../core/mobile-shell/number-wheel-drag.ts";
import { updateNumberWheelSelection } from "../core/mobile-shell/controller-helpers-navigation.ts";

vi.mock("../core/mobile-shell/controller-helpers-navigation.ts", () => ({ updateNumberWheelSelection: vi.fn() }));
